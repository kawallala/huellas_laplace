...
class Enrolar(tk.Frame):
  def __init__(self, master):
    ...
    tk.Entry(self).grid(row=1, column=1, columnspan=2, sticky="ew")
    tk.Label(self, text="Telefono").grid(row=2, column=0, columnspan=1)
    tk.Entry(self).grid(row=2, column=1, columnspan=2, sticky="ew")
    tk.Button(self, text="Cancelar",
              command=lambda: master.switch_frame(StartPage)).grid(row=3, column=0, columnspan=2,sticky="nesw")
    tk.Button(self, text="Continuar",
              command=lambda: master.switch_frame(StartPage)).grid(row=3, column=2, columnspan=2, sticky="nesw")
